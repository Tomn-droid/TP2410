...
<?php
$sql = "SELECT * FROM tabpantalon"; // Remplacez par votre requête SQL
    ...
    <tbody>
        <?php foreach ($results as $row): ?>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['DesignationPantalon']); ?></td>
                <td><?php echo htmlspecialchars($row['MatierePantalon']); ?></td>
                <td><?php echo htmlspecialchars($row['QuantitePantalon']); ?></td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>@twitter</td>
        ...
        -->
<div class="Nvx" ><a href="NouveauxPantalon.php"><button>AJouter nouveau</a></button></div>
<!--Bootstrap-->

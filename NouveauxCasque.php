...
<head>
    ...
    <title>Ajouter nouveau Casque</title>
</head>
<body>
<header>
...
<?php
    ...
    if (isset($_POST['Ajoute'])) {
        echo 'test2';
        $MarqueCasque = $_POST['MarqueCasque'];
        $DesignationCasque = $_POST['DesignationCasque'];
        $MatiereCasque = $_POST['MatiereCasque'];
        $QuantiteCasque = $_POST['QuantiteCasque'];
echo $MarqueCasque;
echo $DesignationCasque;
echo $MatiereCasque;
echo $QuantiteCasque;
        if (!empty($MarqueCasque) && !empty($DesignationCasque) && !empty($MatiereCasque) && !empty($QuantiteCasque)) {
            ...
            $requete->bindvalue(':MarqueCasque', $MarqueCasque);
            $requete->bindvalue(':DesignationCasque', $DesignationCasque);
            $requete->bindvalue(':MatiereCasque', $MatiereCasque);
            $requete->bindvalue(':QuantiteCasque', $QuantiteCasque);
...
<h1>AJOUTER UN PRODUIT CASQUE</h1>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="MarqueCasque" aria-describedby="" placeholder="Marque" name="MarqueCasque">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Designation</label>
    <input type="text" class="form-control" id="DesignationCasque" aria-describedby="" placeholder="Désignation et références" name="DesignationCasque">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Matière</label>
    <input type="text" class="form-control" id="MatiereCasque" aria-describedby="" placeholder="type de matière" name="MatiereCasque">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Quantité reçue</label>
    <input type="number" class="form-control" id="QuantiteCasque" aria-describedby="" placeholder="Quantité reçue" name="QuantiteCasque">
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
